...
module.exports = {
  up: (queryInterface, Sequelize) => {
    let records = [
      ...
      {
        creatorId: 0,
        text: "Lifetime&reg; presents ___, the story of ___.",
        pick: 2
      },
      {
        creatorId: 0,
      ...
      {
        creatorId: 0,
        text: "Dear Abby,<br><br>I'm having some trouble with ___ and would like your advice.",
        pick: 1
      },
      {
        creatorId: 0,
      ...
      {
        creatorId: 0,
        text: "Here is the church<br>Here is the steeple<br>Open the doors<br>And there is ___.",
        pick: 1
      },
      {
        creatorId: 0,
      ...
      {
        creatorId: 0,
        text: "During his childhood, Salvador Dal&iacute; produced hundreds of paintings of ___.",
        pick: 1
      },
      {
        creatorId: 0,
    ...
    return queryInterface.bulkInsert('BlackCards', records, {});
  },

  down: (queryInterface, Sequelize) => {
      return queryInterface.bulkDelete('BlackCards', null, {});
  }
};
